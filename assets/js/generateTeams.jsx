async function fetchData() {
  ...
  function createTeams() {
    ...
    teamsList.forEach((element) => {
      const teamStructure = `<button type="button" class="teamButton"><li class="teamButton"><img src="${element.teamLogo}" class="logoTime" alt="Logo do time"><p>${element.teamName}</p></li></button>`;
